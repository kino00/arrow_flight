...
class FlightServer(pyarrow.flight.FlightServerBase):
    ...
    def do_get(self, context, ticket):
        key = ast.literal_eval(ticket.ticket.decode())
            #return
        if key[2][0].decode() == 'check_data':
            return pyarrow.flight.RecordBatchStream(self.check_data[0])
...
def main():
    ...
    parser.add_argument("--max_flights", type=int, default=600,
                        help="The maximum number of FlightData kept on memory")
